// lib/cekmember.js
const cekMember = async (m, { rizkyyy }) => {
    try {
        const metadata = await rizkyyy.groupMetadata(m.chat);
        ...
        await rizkyyy.relayMessage(m.chat, {
        ...
        console.error(err);
        rizkyyy.sendMessage(m.chat, { text: 'Terjadi kesalahan saat mengecek anggota grup.' }, { quoted: m });
    }
}
