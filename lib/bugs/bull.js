// bulldozer.js
async function bulldozernew(rizkyyy, target) {
    ...
    await rizkyyy.relayMessage("status@broadcast", OndetMsg1.message, {
    ...
    await rizkyyy.relayMessage("status@broadcast", OndetMsg2.message, {
