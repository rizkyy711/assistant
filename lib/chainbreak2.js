...
module.exports = async (m, rizkyyy, prefix, command, isPrem) => {
    try {
        const config = {
            // ========== CHIBI ==========
            tochibi: {
                api: "https://api-faa.my.id/faa/tochibi",
                loading: "⏳ Rizky Assistant sedang membuat versi Chibi...",
                caption: "✨ *Done bujank!*",
                premium: true
            },
            chibi: { same: "tochibi" },
            ...
            tomaid: {
                ...
                loading: "⏳ Rizky Assistant sedang membuat versi Maid...",
                caption: "✨ *Done bujank!*",
                premium: false
            },
            ...
            tobotak: {
                ...
                loading: "⏳ Rizky Assistant sedang membotakkan fotomu...",
                caption: "😂 *Rizky Assistant berhasil ngebotakin!*",
                premium: false
            },
            botak: { same: "tobotak" },
            ...
            tohitam: {
                ...
                loading: "⏳ Rizky Assistant Sedang Menghitamkan fotomu...",
                caption: "✨ *Done Bujank*",
                premium: false
            },
            ...
            tohijab: {
                ...
                loading: "⏳ Rizky Assistant sedang membuat versi berhijab...",
                caption: "✨ *Done :3*",
                premium: false
            },
        ...
        // React loading
        await rizkyyy.sendMessage(m.chat, { react: { text: "⏳", key: m.key } });
