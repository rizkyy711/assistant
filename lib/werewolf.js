...
async function pagi(rizkyyy, x, data) {
    ...
    return await rizkyyy.sendMessage(x.room, {
        text: pagii(x),
        contextInfo: {
            externalAdReply: {
...
async function voting(rizkyyy, x, data) {
    let row = [];
    let ment = [];
...
async function malam(rizkyyy, x, data) {
...
async function skill(rizkyyy, x, data) {
    skillOn(x.room, data)
        ...
        for (let i = 0; i < x.player.length; i++) {
            if (x.player[i].role === "werewolf") {
                if (x.player[i].isdead != true) {
                    ...
                    await rizkyyy.sendMessage(x.player[i].id, {
                        text: textnya,
                        mentions: membernya,
                    });
                }
...
async function win(x, t, rizkyyy, data) {
    ...
    if (getWinner(x.room, data).status === false || x.iswin === false) {
        ...
        return await rizkyyy.sendMessage(sesinya, {
            text: textnya,
            contextInfo: {
                externalAdReply: {
                    title: "W E R E W O L F",
...
// playing
async function run(rizkyyy, id, data) {
    while (getWinner(id, data).status === null) {
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
        } else {
            await sleep(90000);
        }
        if (getWinner(id, data).status != null) {
            ...
            await pagi(rizkyyy, sesi(id, data), data);
        }
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
        ...
        if (getWinner(id, data).status != null) {
            ...
            await voting(rizkyyy, sesi(id, data), data);
        }
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
        ...
        if (getWinner(id, data).status != null) {
            ...
            await malam(rizkyyy, sesi(id, data), data);
        }
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
        } else {
            await skill(rizkyyy, sesi(id, data), data);
        }
        if (getWinner(id, data).status != null) break;
    }
    await win(sesi(id, data), 1, rizkyyy, data);
}

async function run_vote(rizkyyy, id, data) {
    while (getWinner(id, data).status === null) {
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
...
async function run_malam(rizkyyy, id, data) {
    while (getWinner(id, data).status === null) {
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
...
async function run_pagi(rizkyyy, id, data) {
    while (getWinner(id, data).status === null) {
        if (getWinner(id, data).status != null) {
            win(getWinner(id, data), 1, rizkyyy, data);
            break;
